[![Element iOS Matrix room #element-x-ios:matrix.pesbc.chat](https://img.shields.io/matrix/element-x-ios:matrix.pesbc.chat.svg?label=%23element-x-ios:matrix.pesbc.chat&logo=matrix&server_fqdn=matrix.pesbc.chat)](https://matrix.to/#/#element-x-ios:matrix.pesbc.chat)
...
PESenger iOS is a [Matrix](https://matrix.pesbc.chat/) iOS Client provided by [Element](https://element.io/).
...
PESenger leverages the [Matrix Rust SDK](https://github.com/matrix-org/matrix-rust-sdk) through an FFI layer exposed as a [swift package](https://github.com/matrix-org/matrix-rust-components-swift) that the final client can directly import and use. We're doing this as a way to share code between platforms, with [PESenger Android](https://github.com/element-hq/element-x-android) using the same SDK.
...
Come chat with the community in the dedicated Matrix [room](https://matrix.to/#/#element-x-ios:matrix.pesbc.chat).
...
When you are experiencing an issue on PESenger iOS, please first search in [GitHub issues](https://github.com/element-hq/element-x-ios/issues)
and then in [#element-x-ios:matrix.pesbc.chat](https://matrix.to/#/#element-x-ios:matrix.pesbc.chat).
If after your research you still have a question, ask at [#element-x-ios:matrix.pesbc.chat](https://matrix.to/#/#element-x-ios:matrix.pesbc.chat). Otherwise feel free to create a GitHub issue if you encounter a bug or a crash, by explaining clearly in detail what happened. You can also perform bug reporting (Rageshake) from the Element application by going to the application settings. This is especially recommended when you encounter a crash.
