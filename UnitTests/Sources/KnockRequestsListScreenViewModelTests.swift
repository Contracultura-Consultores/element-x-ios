...
class KnockRequestsListScreenViewModelTests: XCTestCase {
    ...
    func testLoadedState() async throws {
        let roomProxyMock = JoinedRoomProxyMock(.init(members: [.mockAdmin],
                                                      knockRequestsState: .loaded([KnockRequestProxyMock(.init(eventID: "1", userID: "@alice:matrix.pesbc.chat")),
                                                                                   KnockRequestProxyMock(.init(eventID: "2", userID: "@bob:matrix.pesbc.chat")),
                                                                                   KnockRequestProxyMock(.init(eventID: "3", userID: "@charlie:matrix.pesbc.chat")),
                                                                                   KnockRequestProxyMock(.init(eventID: "4", userID: "@dan:matrix.pesbc.chat"))]),
    ...
    func testAcceptAll() async throws {
        let roomProxyMock = JoinedRoomProxyMock(.init(knockRequestsState: .loaded([KnockRequestProxyMock(.init(eventID: "1", userID: "@alice:matrix.pesbc.chat")),
                                                                                   KnockRequestProxyMock(.init(eventID: "2", userID: "@bob:matrix.pesbc.chat")),
                                                                                   KnockRequestProxyMock(.init(eventID: "3", userID: "@charlie:matrix.pesbc.chat")),
                                                                                   KnockRequestProxyMock(.init(eventID: "4", userID: "@dan:matrix.pesbc.chat"))]),
                                                      joinRule: .knock))
