...
```
BASE_BUNDLE_IDENTIFIER: io.pesbc.pesenger
APP_DISPLAY_NAME: PESenger
```
...
The location sharing feature on PESenger is currently integrated with [MapLibre](https://maplibre.org).
