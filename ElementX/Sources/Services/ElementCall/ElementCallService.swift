...
class ElementCallService: NSObject, ElementCallServiceProtocol, PKPushRegistryDelegate,
    ...
    func pushRegistry(_ registry: PKPushRegistry, didReceiveIncomingPushWith payload: PKPushPayload,
        ...
        guard
            let roomID = payload.dictionaryPayload[
                ElementCallServiceNotificationKey.roomID.rawValue
            ] as? String
        else {
            MXLog.error(
    ...
    func provider(_ provider: CXProvider, perform action: CXAnswerCallAction) {
        ...
        // https://developer.apple.com/forums//thread/767949?answerId=812951022#812951022
        //
        // https://github.com/Contracultura-Consultores/element-x-ios/issues/3041
    ...
    private func observeIncomingCallRoomInfo() async {
        ...
        guard
            case let .joined(roomProxy) = await clientProxy.roomForIdentifier(incomingCallID.roomID)
        else {
