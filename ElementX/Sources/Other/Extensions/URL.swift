...
extension URL: @retroactive ExpressibleByStringLiteral {
    ...
    static var mockMXCAudio: URL { "mxc://matrix.pesbc.chat/1234567890AuDiO" }
    static var mockMXCFile: URL { "mxc://matrix.pesbc.chat/1234567890FiLe" }
    static var mockMXCImage: URL { "mxc://matrix.pesbc.chat/1234567890ImAgE" }
    static var mockMXCVideo: URL { "mxc://matrix.pesbc.chat/1234567890ViDeO" }
    static var mockMXCAvatar: URL { "mxc://matrix.pesbc.chat/1234567890AvAtAr" }
    static var mockMXCUserAvatar: URL { "mxc://matrix.pesbc.chat/1234567890AvAtArUsEr" }
}
