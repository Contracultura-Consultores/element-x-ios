...
class UITestsAppCoordinator: AppCoordinatorProtocol, SecureWindowManagerDelegate {
    ...
    init(appDelegate: AppDelegate) {
        ...
        AppSettings.configureWithSuiteName("io.pesbc.pesenger.uitests")
    ...
    lazy var coordinator: CoordinatorProtocol? = {
        ...
        case .serverSelection:
            ...
            let coordinator = ServerSelectionScreenCoordinator(
                parameters: .init(authenticationService: AuthenticationService.mock,
        ...
        case .bugReport:
            ...
            let coordinator = BugReportScreenCoordinator(
                parameters: .init(bugReportService: BugReportServiceMock(.init()),
        ...
        case .roomLayoutTop:
            ...
            let parameters = RoomScreenCoordinatorParameters(clientProxy: ClientProxyMock(),
                                                             roomProxy: JoinedRoomProxyMock(
                                                                 .init(name: "Large timeline", avatarURL: .mockMXCAvatar)),
                                                             timelineController: timelineController,
                                                             mediaProvider: MediaProviderMock(configuration: .init()),
                                                             mediaPlayerProvider: MediaPlayerProviderMock(),
                                                             voiceMessageMediaManager: VoiceMessageMediaManagerMock(),
        ...
        case .roomWithDisclosedPolls:
            ...
            let parameters = RoomScreenCoordinatorParameters(clientProxy: ClientProxyMock(),
                                                             roomProxy: JoinedRoomProxyMock(
                                                                 .init(name: "Polls timeline", avatarURL: .mockMXCAvatar)),
                                                             timelineController: timelineController,
                                                             mediaProvider: MediaProviderMock(configuration: .init()),
                                                             mediaPlayerProvider: MediaPlayerProviderMock(),
                                                             voiceMessageMediaManager: VoiceMessageMediaManagerMock(),
        ...
        case .sessionVerification:
            var sessionVerificationControllerProxy =
                SessionVerificationControllerProxyMock.configureMock(requestDelay: .seconds(5))
        ...
        case .userSessionScreen, .userSessionScreenReply:
            ...
            let clientProxy = ClientProxyMock(
                .init(userID: "@mock:client.com", deviceID: "MOCKCLIENT",
                      roomSummaryProvider: RoomSummaryProviderMock(.init(state: .loaded(.mockRooms))))
            )
        ...
        case .roomMembersListScreenPendingInvites:
            ...
            let coordinator = RoomMembersListScreenCoordinator(
                parameters: .init(clientProxy: ClientProxyMock(.init()),
        ...
        case .roomRolesAndPermissionsFlow:
            ...
            let coordinator = RoomRolesAndPermissionsFlowCoordinator(
                parameters: .init(roomProxy: JoinedRoomProxyMock(.init(members: .allMembersAsAdmin)),
                                  mediaProvider: MediaProviderMock(configuration: .init()),
                                  navigationStackCoordinator: navigationStackCoordinator,
                                  userIndicatorController: ServiceLocator.shared.userIndicatorController,
                                  analytics: ServiceLocator.shared.analytics))
        ...
        case .startChat:
            ...
            let userSession = UserSessionMock(
                .init(clientProxy: ClientProxyMock(.init(userID: "@mock:client.com"))))
        ...
        case .startChatWithSearchResults:
            ...
            let userSession = UserSessionMock(.init(clientProxy: clientProxy))
            let coordinator = StartChatScreenCoordinator(
                parameters: .init(orientationManager: OrientationManagerMock(),
                                  userSession: userSession,
                                  userIndicatorController: UserIndicatorControllerMock(),
                                  navigationStackCoordinator: navigationStackCoordinator,
                                  userDiscoveryService: userDiscoveryMock,
        ...
        case .encryptionSettings, .encryptionSettingsOutOfSync:
            ...
            let coordinator = EncryptionSettingsFlowCoordinator(
                parameters: .init(userSession: userSession,
                                  appSettings: ServiceLocator.shared.settings,
                                  userIndicatorController: UserIndicatorControllerMock(),
                                  navigationStackCoordinator: navigationStackCoordinator))
            retainedState.append(coordinator)
        ...
        case .autoUpdatingTimeline:
            ...
            let timelineController = TimelineController(roomProxy: roomProxy,
                                                        ...
                                                        timelineItemFactory: RoomTimelineItemFactory(userID: "@alice:matrix.pesbc.chat",
