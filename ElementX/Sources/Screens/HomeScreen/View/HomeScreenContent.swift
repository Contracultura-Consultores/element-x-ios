...
struct HomeScreenContent: View {
    ...
    private var roomList: some View {
        GeometryReader { geometry in
            ...
            .onChange(of: context.viewState.visibleRooms) {
                ...
                // * Tapping on the room list doesn't always take you to the right room  - https://github.com/Contracultura-Consultores/element-x-ios/issues/2386
                // * Big blank gaps in the room list - https://github.com/Contracultura-Consultores/element-x-ios/issues/3026
                //
            ...
            .scrollBounceBehavior(
                context.viewState.roomListMode == .empty ? .basedOnSize : .automatic
            )
    ...
    private func delayedUpdateVisibleRange() {
        ...
        let adjustedContentSize = max(scrollView.contentSize.height - scrollView.contentInset.top
