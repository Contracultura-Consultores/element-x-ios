...
struct ReadReceiptsSummaryView_Previews: PreviewProvider, TestablePreview {
    ...
    static let orderedReadReceipts: [ReadReceipt] = [
        .init(userID: "@alice:matrix.pesbc.chat", formattedTimestamp: "10:00"),
        .init(userID: "@bob:matrix.pesbc.chat", formattedTimestamp: "9:30"),
        .init(userID: "@charlie:matrix.pesbc.chat", formattedTimestamp: "9:00"),
        .init(userID: "@dan:matrix.pesbc.chat", formattedTimestamp: "8:30"),
        .init(userID: "@loading:matrix.pesbc.chat", formattedTimestamp: "Long time ago")
    ]
