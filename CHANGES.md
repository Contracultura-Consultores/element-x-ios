...
- Fix a bug where you couldn't log in to matrix.pesbc.chat by @pixlwave in https://github.com/element-hq/element-x-ios/pull/3829
...
- Allow registration on matrix.pesbc.chat using a custom helper URL. by @pixlwave in https://github.com/element-hq/element-x-ios/pull/3282
...
- Fix a bug where the server versions for matrix.pesbc.chat were used when signing in to a different server. by @pixlwave in https://github.com/element-hq/element-x-ios/pull/3155
...
- Update the link of the element ios room to be the PESenger ios support room in CONTRIBUTING.md and README.md by Sem Pruijs ([#668](https://github.com/vector-im/element-x-ios/pull/668))
...
- Hardcode the sliding sync proxy to matrix.pesbc.chat for FOSDEM demo. ([#502](https://github.com/vector-im/element-x-ios/pull/502))
